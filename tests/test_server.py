...
class TestListFiles:
    ...
    def test_list_files_with_folder_id(self, mock_client, mock_drive_service):
        ...
        result = list_files(folder_id="folder_123")
    ...
    def test_list_files_with_mime_type(self, mock_client, mock_drive_service):
        ...
        result = list_files(mime_type="application/vnd.google-apps.document")
    ...
    def test_list_files_page_size_limit(self, mock_client, mock_drive_service):
        ...
        result = list_files(page_size=150)  # Above max of 100
...
class TestReadDocument:
    ...
    def test_read_document_start_index_beyond_length(self, mock_client, mock_docs_service):
